...
function loadPreset() {
  ...
  const elements = {
    ...
    'lfoFrequency': ['value', 'lfoFreqValue', ' Hz'],
    'lfoAmount': ['value', 'lfoAmountValue', '%'],
    'lfoWaveform': ['value'],
    'reverbMix1': ['value', 'reverbMix1Value', '%'],
    'reverbDecay1': ['value', 'reverbDecay1Value', 's'],
    ...
    'flangerDelay': ['value', 'flangerDelayValue', 's'],
    'flangerDepth': ['value', 'flangerDepthValue', ''],
    'flangerRate': ['value', 'flangerRateValue', ' Hz'],
    'flangerFeedback': ['value', 'flangerFeedbackValue', ''],
    'chorusRate': ['value', 'chorusRateValue', ' Hz'],
    'chorusDelay': ['value', 'chorusDelayValue', 's'],
    'chorusDepth': ['value', 'chorusDepthValue', ''],
    'chorusMix': ['value', 'chorusMixValue', '%']
  };
